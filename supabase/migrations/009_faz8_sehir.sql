...
grant execute on function public.sehir_destekle to authenticated;
grant execute on function public.sehir_aday_basvurusu to authenticated;
grant execute on function public.sehir_oyu_kullan to authenticated;
grant execute on function public.sehir_secim_olustur_dev to authenticated;
grant execute on function public.sehir_secimi_oylamaya_ac_dev to authenticated;
grant execute on function public.sehir_savas_skor_ekle to authenticated;
